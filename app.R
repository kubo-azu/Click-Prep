...
ui <- fluidPage(
  ...
  div(style = "display: flex; align-items: center; margin-bottom: 20px;",
      div(
        ...
        div(style = "text-align: left; margin-top: 10px; font-size: 17px; color: #555;", "🧬 App Version: v1.2.1 🧬"),
               ...
               column(width = 12,
                      div( 
                        ...
                        tags$ol(style = "font-size: 17px; color: #333; line-height: 1.5;",
                                tags$li(strong("Import and Column Mapping: "), "Upload a qPCR instrument output file (.csv, .txt, .tsv, .xls, or .xlsx). Use the 'Skip' option to omit instrument-generated metadata rows above the column headers. Then, map the relevant columns to the required 'sample', 'group', 'gene', and 'Cq' fields."),
    ...
    tabPanel("Import and Column Mapping",
             ...
             sidebarLayout(
               sidebarPanel(width = 6,
                            ...
                            p("Supported formats: .csv, .txt, .tsv, .xls, .xlsx", style = "font-size: 16px;"),
